...
struct ComponentGroup: Identifiable {
  ...
  static let samples = [
    ...
    ComponentGroup(id: "contactors", name: "Contactors", items: [
      PanelComponent(id: "abb-af16-30-10", manufacturer: "ABB", type: "Contactor", model: "AF16-30-10", rating: "18A AC-3, 7.5kW", poles: "3P", curve: "1NO aux", about: "Three-pole AF contactor, 18A AC-3 at 400V, about 7.5kW, for small motors and controlled loads. In AF16-30-10-13 the blocks are frame, main poles, auxiliaries, coil."),
      PanelComponent(id: "abb-af26-30-00", manufacturer: "ABB", type: "Contactor", model: "AF26-30-00", rating: "26A AC-3, 11kW", poles: "3P", curve: "No aux", about: "Mid-size three-pole AF at 26A AC-3 at 400V, about 11kW, with no built-in auxiliary. Add-on blocks mount front or side."),
      PanelComponent(id: "abb-af38-30-00", manufacturer: "ABB", type: "Contactor", model: "AF38-30-00", rating: "38A AC-3, 18.5kW", poles: "3P", curve: "No aux", about: "Three-pole AF at 38A AC-3 at 400V, about 18.5kW. Size on the AC-3 figure against motor full-load amps; the AC-1 rating of the same frame is higher."),
      PanelComponent(id: "abb-af-3p", manufacturer: "ABB", type: "Contactor", model: "AF three-pole (AF09-AF2850)", rating: "9-2850A, to 560kW", poles: "3P", curve: "AC-3, electronic coil", about: "The main ABB motor contactor range, AF09 to AF2850, roughly 4kW to 560kW at 400V AC-3. The number after AF is a frame size, not a current: AF16 is 18A AC-3, not 16A."),
