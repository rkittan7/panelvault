...
enum ComponentIcon {
  ...
  static func symbol(for type: String) -> String {
    ...
    if lowered.contains("twilight") { return "sun.haze.fill" }
...
struct ComponentGroup: Identifiable {
  ...
  static let samples = [
    ComponentGroup(id: "mcbs", name: "MCBs", items: [
      PanelComponent(id: "abb-s201-1p", manufacturer: "ABB", type: "MCB", model: "S201", rating: "0.5-63A", poles: "1P", curve: "B/C/D Curve", about: "Single-pole miniature circuit breaker for one final circuit, protecting against overload and short circuit. Pick the curve for the load: B for resistive and lighting, C for general mixed loads, D for high-inrush motors and transformers."),
      PanelComponent(id: "abb-s202-2p", manufacturer: "ABB", type: "MCB", model: "S202", rating: "0.5-63A", poles: "2P", curve: "B/C/D Curve", about: "Two-pole MCB that breaks line and neutral together, common on single-phase circuits where full isolation is required for maintenance."),
      PanelComponent(id: "abb-s203-3p", manufacturer: "ABB", type: "MCB", model: "S203", rating: "0.5-63A", poles: "3P", curve: "B/C/D Curve", about: "Three-pole MCB for three-phase loads. All three poles trip together so a fault on one phase cannot leave a motor running single-phased."),
    ...
    ComponentGroup(id: "mccbs", name: "MCCBs & ACBs", items: [
      PanelComponent(id: "abb-tmax-xt1", manufacturer: "ABB", type: "MCCB", model: "SACE Tmax XT1", rating: "IEC 160A frame, Icu 18-70kA", poles: "3P/4P", curve: "TMD/TMA", about: "160A moulded case breaker for outgoing ways on small distribution boards. Classes set interrupting capacity only: B 18, C 25, N 36, S 50, H 70 kA at 415V."),
      PanelComponent(id: "abb-tmax-xt2", manufacturer: "ABB", type: "MCCB", model: "SACE Tmax XT2", rating: "IEC 160A frame, Icu 36-150kA", poles: "3P/4P", curve: "TMA or Ekip Dip", about: "160A frame taking thermal-magnetic or Ekip trip units for selectivity against downstream devices. Classes: N 36, S 50, H 70, L 120, V 150 kA at 415V."),
      PanelComponent(id: "abb-tmax-xt3", manufacturer: "ABB", type: "MCCB", model: "SACE Tmax XT3", rating: "IEC 250A frame, Icu 25-50kA", poles: "3P/4P", curve: "TMA", about: "250A frame for mid-size feeders and sub-board supplies, normally with a TMA trip unit. Classes: C 25, N 36, S 50 kA at 415V."),
      PanelComponent(id: "abb-tmax-xt4", manufacturer: "ABB", type: "MCCB", model: "SACE Tmax XT4", rating: "IEC 250A frame, Icu 36-200kA", poles: "3P/4P", curve: "TMA/MA or Ekip", about: "250A frame with electronic trip options where settings must coordinate with upstream protection. Classes: N 36, S 50, H 70, L 120, V 150, X 200 kA at 415V."),
      PanelComponent(id: "abb-tmax-xt5", manufacturer: "ABB", type: "MCCB", model: "SACE Tmax XT5", rating: "IEC 630A frame, Icu 36-200kA", poles: "3P/4P", curve: "TMA or Ekip", about: "630A frame for major feeders and transformer outgoings, usually 400A or 630A. Classes: N 36, S 50, H 70, L 120, V 150, X 200 kA at 415V."),
      PanelComponent(id: "abb-tmax-xt6", manufacturer: "ABB", type: "MCCB", model: "SACE Tmax XT6", rating: "IEC 1000A frame, Icu 36-70kA", poles: "3P/4P", curve: "TMA or Ekip", about: "1000A frame for main incomers and large plant, usually 630A, 800A or 1000A. Classes: N 36, S 50, H 70 kA at 415V."),
      PanelComponent(id: "abb-tmax-xt7", manufacturer: "ABB", type: "MCCB", model: "SACE Tmax XT7", rating: "IEC 1600A frame, Icu 50-120kA", poles: "3P/4P", curve: "Ekip electronic", about: "1600A frame for main incoming protection where an air circuit breaker is not needed, usually 800A to 1600A. Classes: S 50, H 70, L 120 kA at 415V."),
      PanelComponent(id: "abb-tmax-xt7m", manufacturer: "ABB", type: "MCCB", model: "SACE Tmax XT7 M", rating: "IEC 1600A frame, Icu 50-120kA", poles: "3P/4P", curve: "Ekip, stored-energy", about: "XT7 with a stored-energy mechanism for rapid or remote closing. The M is the mechanism, not a trip unit. Classes: S 50, H 70, L 120 kA at 415V."),
      ...
      PanelComponent(id: "abb-emax2", manufacturer: "ABB", type: "ACB", model: "SACE Emax 2", rating: "IEC 630-6300A range", poles: "3P/4P", curve: "Ekip Dip/Touch/Hi-Touch", about: "The SACE Emax 2 range, in the E1.2, E2.2, E4.2 and E6.2 frames. Fixed or withdrawable, with Ekip trip units covering protection, metering and communications."),
      ...
      PanelComponent(id: "abb-emax2-e12", manufacturer: "ABB", type: "ACB", model: "SACE Emax 2 E1.2", rating: "IEC to 1600A, Icw 50kA/1s", poles: "3P/4P", curve: "Ekip Dip/Touch", about: "1600A air circuit breaker frame. Classes B, C, N and L set short-circuit performance, not a trip curve. Icu depends on class and voltage; take it from the ABB table."),
      PanelComponent(id: "abb-emax2-e22", manufacturer: "ABB", type: "ACB", model: "SACE Emax 2 E2.2", rating: "IEC to 2500A, Icw 85kA/1s", poles: "3P/4P", curve: "Ekip Dip/Touch/Hi-Touch", about: "2500A frame with classes B, N, S and H. The letter is a short-circuit performance level only; an E2.2N is not an N trip curve."),
      PanelComponent(id: "abb-emax2-e42", manufacturer: "ABB", type: "ACB", model: "SACE Emax 2 E4.2", rating: "IEC to 4000A, Icw 100kA/1s", poles: "3P/4P", curve: "Ekip Dip/Touch/Hi-Touch", about: "4000A frame with classes N, S, H and V, high-performance versions reaching about 150kA. Do not apply the family maximum to every breaker."),
      PanelComponent(id: "abb-emax2-e62", manufacturer: "ABB", type: "ACB", model: "SACE Emax 2 E6.2", rating: "IEC to 6300A, Icw to 120kA", poles: "3P/4P", curve: "Ekip Touch/Hi-Touch", about: "6300A frame with classes H, V and X. Never carry a Tmax XT breaking-capacity figure across to an Emax 2: the letters do not mean the same kA."),
      PanelComponent(id: "abb-emax-legacy", manufacturer: "ABB", type: "Legacy ACB", model: "SACE Emax legacy", rating: "Legacy - verify before reuse", poles: "3P/4P", curve: "E1 to E6, Emax, X1", about: "Legacy ABB Emax families. They do not map onto E1.2-E6.2, so check spare-parts compatibility and any retrofit kit before treating one as a replacement.")
    ]),
    ComponentGroup(id: "surge-arc", name: "Surge & Arc Protection", items: [
      ...
      PanelComponent(id: "abb-ovr", manufacturer: "ABB", type: "SPD Type 2", model: "OVR T2", rating: "Imax 20-80kA, 8/20", poles: "1P-4P", curve: "Sub-distribution", about: "Type 2 SPD for induced lightning and switching surges in distribution boards. Selected on In and Imax, not on kA alone. P is pluggable, TS adds remote signalling."),
      ...
      PanelComponent(id: "abb-ovr-t1", manufacturer: "ABB", type: "SPD Type 1", model: "OVR T1", rating: "Iimp, 10/350 wave", poles: "1P-4P", curve: "Service entrance", about: "Type 1 SPD for partial or direct lightning current at the service entrance. Selected on Iimp. A low Up is not implied, so a Type 2 stage often follows it."),
      PanelComponent(id: "abb-ovr-t1-t2", manufacturer: "ABB", type: "SPD Type 1+2", model: "OVR T1-T2", rating: "Iimp + Imax", poles: "1P-4P", curve: "Main distribution", about: "Combined Type 1+2 for main distribution, covering lightning current and switching surges in one device. OVR T1-T2-T3 adds a Type 3 stage for a lower protection level."),
      PanelComponent(id: "abb-ovr-t2-t3", manufacturer: "ABB", type: "SPD Type 2+3", model: "OVR T2-T3", rating: "Imax + Uoc", poles: "1P-4P", curve: "Final distribution", about: "Combined Type 2+3 for final distribution and sensitive equipment, where a Type 2 stage alone leaves the protection level too high."),
      PanelComponent(id: "abb-ovr-t3", manufacturer: "ABB", type: "SPD Type 3", model: "OVR T3", rating: "Uoc, combination wave", poles: "1P-2P", curve: "Point of use", about: "Type 3 SPD installed near sensitive equipment, the lowest-energy stage. It must sit downstream of a Type 1 or Type 2 and is not a service-entrance device."),
      PanelComponent(id: "abb-ovr-pv", manufacturer: "ABB", type: "PV SPD", model: "OVR PV", rating: "Ucpv DC", poles: "2P-3P", curve: "Photovoltaic DC", about: "SPD for PV strings, combiners and inverter DC inputs. Rated on maximum continuous DC voltage. An AC SPD must never be fitted to a DC PV circuit."),
      PanelComponent(id: "abb-ovr-tc", manufacturer: "ABB", type: "Data SPD", model: "OVR TC", rating: "Signal lines", poles: "1P-2P", curve: "Telecom and data", about: "SPD for telephone, signal and communication lines. Selected on signal voltage, bandwidth and insertion loss, not on a mains rating."),
      PanelComponent(id: "abb-ovr-ul", manufacturer: "ABB", type: "SPD (UL)", model: "OVR HLD/HR/HTP/HS", rating: "MCOV, VPR, SCCR", poles: "Varies", curve: "UL 1449", about: "North American OVR ranges for control panels, residential service entrances and commercial panels. Rated to UL with MCOV, VPR and SCCR: keep apart from the IEC rows.")
    ]),
    ComponentGroup(id: "switching", name: "Switching & Isolation", items: [
      ...
      PanelComponent(id: "abb-emax2-e22-ms", manufacturer: "ABB", type: "Switch-Disconnector", model: "SACE Emax 2 E2.2/MS", rating: "IEC to 2500A", poles: "3P/4P", curve: "No automatic protection", about: "Emax 2 switch-disconnector in the E2.2 frame. No trip unit, so it provides isolation only and depends on an upstream protective device."),
      PanelComponent(id: "abb-emax2-e42-ms", manufacturer: "ABB", type: "Switch-Disconnector", model: "SACE Emax 2 E4.2/MS", rating: "IEC to 4000A", poles: "3P/4P", curve: "No automatic protection", about: "Emax 2 switch-disconnector in the E4.2 frame. No trip unit, so it provides isolation only and depends on an upstream protective device."),
      PanelComponent(id: "abb-emax2-e62-ms", manufacturer: "ABB", type: "Switch-Disconnector", model: "SACE Emax 2 E6.2/MS", rating: "IEC to 6300A", poles: "3P/4P", curve: "No automatic protection", about: "Emax 2 switch-disconnector in the E6.2 frame. No trip unit, so it provides isolation only and depends on an upstream protective device.")
    ]),
    ComponentGroup(id: "fuses", name: "Fuses & Fusegear", items: [
      ...
      PanelComponent(id: "abb-kabeldon", manufacturer: "ABB", type: "Fusegear System", model: "Kabeldon", rating: "Utility distribution", poles: "Varies", curve: "Outdoor cable distribution", about: "Outdoor utility cable-distribution system with fuse-switch and busbar components. Not a DIN-rail product and not interchangeable with one."),
      PanelComponent(id: "abb-fuse-monitor", manufacturer: "ABB", type: "Fuse Monitoring", model: "EFM / ITS2", rating: "Per phase", poles: "Varies", curve: "Electronic monitoring", about: "Electronic fuse monitoring and intelligent monitoring units reporting per-phase fuse state, current and temperature. A striker fuse alone gives no remote signal.")
    ]),
    ComponentGroup(id: "contactors", name: "Contactors", items: [
      PanelComponent(id: "abb-af09", manufacturer: "ABB", type: "Contactor", model: "AF09", rating: "9A AC-3, 4kW", poles: "3P", curve: "TF42 / EF19 overload", about: "9A in AC-3 at 400V, about 4kW. Overload protection comes from a separate TF42 or EF19 relay."),
      PanelComponent(id: "abb-af12", manufacturer: "ABB", type: "Contactor", model: "AF12", rating: "12A AC-3, 5.5kW", poles: "3P", curve: "TF42 / EF19 overload", about: "12A in AC-3 at 400V, about 5.5kW. Overload protection comes from a separate TF42 or EF19 relay."),
      PanelComponent(id: "abb-af16-30-10", manufacturer: "ABB", type: "Contactor", model: "AF16", rating: "18A AC-3, 7.5kW", poles: "3P", curve: "TF42 / EF19 overload", about: "18A in AC-3 at 400V, about 7.5kW. Overload protection comes from a separate TF42 or EF19 relay."),
      PanelComponent(id: "abb-af26-30-00", manufacturer: "ABB", type: "Contactor", model: "AF26", rating: "26A AC-3, 11kW", poles: "3P", curve: "TF42 / EF45 overload", about: "26A in AC-3 at 400V, about 11kW. Overload protection comes from a separate TF42 or EF45 relay."),
      PanelComponent(id: "abb-af30", manufacturer: "ABB", type: "Contactor", model: "AF30", rating: "32A AC-3, 15kW", poles: "3P", curve: "TF42 / EF45 overload", about: "32A in AC-3 at 400V, about 15kW. Overload protection comes from a separate TF42 or EF45 relay."),
      PanelComponent(id: "abb-af38-30-00", manufacturer: "ABB", type: "Contactor", model: "AF38", rating: "38A AC-3, 18.5kW", poles: "3P", curve: "TF42 / EF45 overload", about: "38A in AC-3 at 400V, about 18.5kW. Overload protection comes from a separate TF42 or EF45 relay."),
      PanelComponent(id: "abb-af40", manufacturer: "ABB", type: "Contactor", model: "AF40", rating: "37A AC-3, 18.5kW", poles: "3P", curve: "TF65 / EF45 overload", about: "37A in AC-3 at 400V, about 18.5kW. Overload protection comes from a separate TF65 or EF45 relay."),
      PanelComponent(id: "abb-af52", manufacturer: "ABB", type: "Contactor", model: "AF52", rating: "50A AC-3, 22kW", poles: "3P", curve: "TF65 / EF65 overload", about: "50A in AC-3 at 400V, about 22kW. Overload protection comes from a separate TF65 or EF65 relay."),
      PanelComponent(id: "abb-af65", manufacturer: "ABB", type: "Contactor", model: "AF65", rating: "65A AC-3, 30kW", poles: "3P", curve: "TF65 / EF65 overload", about: "65A in AC-3 at 400V, about 30kW. Overload protection comes from a separate TF65 or EF65 relay."),
      PanelComponent(id: "abb-af80", manufacturer: "ABB", type: "Contactor", model: "AF80", rating: "80A AC-3, 37kW", poles: "3P", curve: "TF96 / EF96 overload", about: "80A in AC-3 at 400V, about 37kW. Overload protection comes from a separate TF96 or EF96 relay."),
      PanelComponent(id: "abb-af96", manufacturer: "ABB", type: "Contactor", model: "AF96", rating: "96A AC-3, 45kW", poles: "3P", curve: "TF96 / EF96 overload", about: "96A in AC-3 at 400V, about 45kW. Overload protection comes from a separate TF96 or EF96 relay."),
      PanelComponent(id: "abb-af116", manufacturer: "ABB", type: "Contactor", model: "AF116", rating: "116A AC-3, 55kW", poles: "3P", curve: "TF140DU / EF146 overload", about: "116A in AC-3 at 400V, about 55kW. Overload protection comes from a separate TF140DU or EF146 relay."),
      PanelComponent(id: "abb-af140", manufacturer: "ABB", type: "Contactor", model: "AF140", rating: "140A AC-3, 75kW", poles: "3P", curve: "TF140DU / EF146 overload", about: "140A in AC-3 at 400V, about 75kW. Overload protection comes from a separate TF140DU or EF146 relay."),
      PanelComponent(id: "abb-af146", manufacturer: "ABB", type: "Contactor", model: "AF146", rating: "146A AC-3, 75kW", poles: "3P", curve: "TF140DU / EF146 overload", about: "146A in AC-3 at 400V, about 75kW. Overload protection comes from a separate TF140DU or EF146 relay."),
      PanelComponent(id: "abb-af190", manufacturer: "ABB", type: "Contactor", model: "AF190", rating: "190A AC-3, 90kW", poles: "3P", curve: "TA200DU / EF205 overload", about: "190A in AC-3 at 400V, about 90kW. Overload protection comes from a separate TA200DU or EF205 relay."),
      PanelComponent(id: "abb-af205", manufacturer: "ABB", type: "Contactor", model: "AF205", rating: "205A AC-3, 110kW", poles: "3P", curve: "TA200DU / EF205 overload", about: "205A in AC-3 at 400V, about 110kW. Overload protection comes from a separate TA200DU or EF205 relay."),
      PanelComponent(id: "abb-af265", manufacturer: "ABB", type: "Contactor", model: "AF265", rating: "265A AC-3, 132kW", poles: "3P", curve: "EF370 overload", about: "265A in AC-3 at 400V, about 132kW. Overload protection comes from a separate EF370 relay."),
      PanelComponent(id: "abb-af305", manufacturer: "ABB", type: "Contactor", model: "AF305", rating: "305A AC-3, 160kW", poles: "3P", curve: "EF370 overload", about: "305A in AC-3 at 400V, about 160kW. Overload protection comes from a separate EF370 relay."),
      PanelComponent(id: "abb-af370", manufacturer: "ABB", type: "Contactor", model: "AF370", rating: "370A AC-3, 200kW", poles: "3P", curve: "EF370 overload", about: "370A in AC-3 at 400V, about 200kW. Overload protection comes from a separate EF370 relay."),
      PanelComponent(id: "abb-af-3p", manufacturer: "ABB", type: "Contactor", model: "AF400-AF2850", rating: "To 2850A AC-1, 560kW AC-3", poles: "3P", curve: "Coil codes 68-71", about: "The large AF frames, AF400 through AF2850. Ratings do not follow from the model number: take AC-1, AC-3 and motor power from the ABB product record."),
      PanelComponent(id: "abb-af-z", manufacturer: "ABB", type: "Contactor", model: "AFZ low-consumption", rating: "9-38A", poles: "3P/4P", curve: "Low-consumption coil", about: "Low-consumption AF for PLC control and supplies prone to voltage dips. Coil code 30 is a dedicated 24V DC PLC coil. Not interchangeable with standard AF."),
      PanelComponent(id: "abb-af-s", manufacturer: "ABB", type: "Safety Contactor", model: "AFS safety (AFS09-AFS750)", rating: "9-750A", poles: "3P", curve: "Safety, mirror contacts", about: "AF built for safety-related switching, with mirror and mechanically linked contacts. The contactor alone does not set a performance level. Never substitute a plain AF."),
      PanelComponent(id: "abb-af-c", manufacturer: "ABB", type: "Contactor", model: "AFC AC-control", rating: "9-2850A", poles: "3P/4P", curve: "AC control coil", about: "AC-control contactor family. Preserve the coil-voltage suffix: the standard AF wide-band AC/DC coil data does not apply."),
      PanelComponent(id: "abb-af-b", manufacturer: "ABB", type: "Railway Contactor", model: "AF..B railway", rating: "Rolling stock", poles: "3P/4P", curve: "EN 50155", about: "Railway-qualified AF for rolling stock, built for vibration, shock and fire and smoke requirements. RT is the ring-tongue terminal version."),
      PanelComponent(id: "abb-b-mini", manufacturer: "ABB", type: "Mini Contactor", model: "B mini-contactor", rating: "To 5.5kW", poles: "3P/4P", curve: "AC coil", about: "Compact AC-operated mini-contactor to about 5.5kW at 400V AC-3. Screw, solder-pin and flat-pin terminals."),
      PanelComponent(id: "abb-bc-mini", manufacturer: "ABB", type: "Mini Contactor", model: "BC mini-contactor", rating: "To 5.5kW", poles: "3P/4P", curve: "DC coil", about: "DC-operated mini-contactor for compact motor and power switching. The DC coil is what separates it from the B family."),
      PanelComponent(id: "abb-m-mini", manufacturer: "ABB", type: "Mini Contactor", model: "M mini-contactor", rating: "Mini frame", poles: "3P/4P", curve: "AC or DC coil", about: "Higher-performance mini-contactor with AC or DC coil options and several terminal types."),
      PanelComponent(id: "abb-ua", manufacturer: "ABB", type: "Capacitor Contactor", model: "UA capacitor switching", rating: "AC-6b kvar", poles: "3P", curve: "Capacitor duty", about: "Capacitor contactor for power-factor correction banks, rated in AC-6b kvar rather than motor amps. The RA version adds damping resistors."),
      PanelComponent(id: "abb-gf", manufacturer: "ABB", type: "DC Contactor", model: "GF DC switching", rating: "DC switching", poles: "Varies", curve: "PV, storage, EV", about: "DC-switching contactor for PV, battery storage, EV charging and DC distribution. An AC current rating never transfers to DC duty."),
      PanelComponent(id: "abb-esb", manufacturer: "ABB", type: "Installation Contactor", model: "ESB modular", rating: "16-100A", poles: "2P/4P", curve: "DIN rail, hum-free", about: "Modular DIN-rail installation contactor, about 16 to 100A, for lighting, heating, ventilation and pumps. Hum-free AC/DC design."),
      PanelComponent(id: "abb-en-inst", manufacturer: "ABB", type: "Installation Contactor", model: "EN manual/automatic", rating: "16-100A", poles: "2P/4P", curve: "DIN rail, manual override", about: "Installation contactor with a manual and automatic selector, for building loads that need an override at the board."),
      PanelComponent(id: "abb-dp", manufacturer: "ABB", type: "Definite-Purpose Contactor", model: "DP definite purpose", rating: "20-75A", poles: "1P-4P", curve: "UL/CSA, HVAC", about: "Definite-purpose contactor for HVAC, refrigeration and compressors, about 20 to 75A. Rated to UL/CSA, not the IEC AF structure."),
      PanelComponent(id: "abb-nema-motor", manufacturer: "ABB", type: "NEMA Contactor", model: "NEMA motor contactor", rating: "By NEMA size", poles: "3P", curve: "UL/CSA", about: "North American motor contactor sized by NEMA size rather than an IEC frame. Rated to UL/CSA."),
      PanelComponent(id: "abb-nema-lighting", manufacturer: "ABB", type: "Lighting Contactor", model: "NEMA lighting contactor", rating: "Multi-pole", poles: "Multi", curve: "UL/CSA, AC-5a/5b", about: "Lighting contactor for commercial and industrial lighting. Lamp loads switch under AC-5a or AC-5b, not a motor AC-3 rating."),
      PanelComponent(id: "abb-a-ae", manufacturer: "ABB", type: "Legacy Contactor", model: "A and AE legacy", rating: "Legacy", poles: "3P/4P", curve: "Conventional coil", about: "Legacy conventional-coil contactor in older installations. An AF is the usual replacement, but coil and accessories do not map across one for one."),
      PanelComponent(id: "abb-al", manufacturer: "ABB", type: "Legacy Contactor", model: "AL legacy DC coil", rating: "Legacy", poles: "3P/4P", curve: "DC coil", about: "Legacy DC-coil contactor from older DC-controlled installations."),
      PanelComponent(id: "abb-tal", manufacturer: "ABB", type: "Legacy Contactor", model: "TAL legacy", rating: "Legacy", poles: "Varies", curve: "Verify type number", about: "Legacy ABB contactor family. Keep the exact type number and check the ABB cross-reference before assuming an AF equivalent."),
      PanelComponent(id: "abb-ek", manufacturer: "ABB", type: "Legacy Contactor", model: "EK legacy large", rating: "Legacy", poles: "3P/4P", curve: "High current", about: "Legacy large contactor from older high-current installations. Replacement contact sets and coils are ZL and ZAF items."),
      PanelComponent(id: "abb-af-4p", manufacturer: "ABB", type: "Contactor", model: "AF 4-pole (AF40-AF80)", rating: "40-80A", poles: "4P", curve: "4 main poles", about: "Four-pole AF for non-inductive loads, neutral switching and distribution. Not a substitute for a three-pole AF on motor duty."),
      PanelComponent(id: "abb-ax", manufacturer: "ABB", type: "Contactor", model: "AX range (AX09-AX260)", rating: "9-260A", poles: "3P", curve: "Verify, outside master", about: "AX three-pole contactors to 690V, frames AX09 to AX260. Not in the current ABB family classification, so verify before relying on it."),
      PanelComponent(id: "abb-ua-ra", manufacturer: "ABB", type: "Capacitor Contactor", model: "UA..RA (UA16-UA110)", rating: "UA16-UA110 kvar", poles: "3P", curve: "AC-6b, damping resistors", about: "Capacitor contactor with damping resistors, which cut the inrush peak as a stage energises. Rated in AC-6b kvar; a motor contactor welds on this duty."),
      PanelComponent(id: "abb-gaf", manufacturer: "ABB", type: "DC Contactor", model: "GAF DC switching", rating: "DC switching", poles: "Varies", curve: "High-current DC", about: "Large DC-switching contactor for high-current DC. A DC arc has no current zero to extinguish at, so an AC contactor is not a substitute."),
    ...
    ComponentGroup(id: "motor-protection", name: "Motor Protection & Starters", items: [
      PanelComponent(id: "abb-ms116", manufacturer: "ABB", type: "MPCB", model: "MS116", rating: "0.1-32A", poles: "3P", curve: "Thermal + magnetic, 45mm", about: "Standard manual motor starter, thermal and magnetic protection. The suffix is the top of an adjustable range, not a fixed trip: MS116-16 adjusts 10-16A."),
      PanelComponent(id: "abb-ms132", manufacturer: "ABB", type: "MPCB", model: "MS132", rating: "0.1-32A", poles: "3P", curve: "Thermal + magnetic, trip indication", about: "Higher-performance manual motor starter with separate trip and magnetic-trip indication and a lockable handle. Icu varies by suffix and voltage."),
      PanelComponent(id: "abb-ms132-k", manufacturer: "ABB", type: "MPCB", model: "MS132-K", rating: "0.1-32A", poles: "3P", curve: "Push-in spring terminals", about: "MS132 protection with push-in spring terminals for tool-free wiring and no retightening. Stock separately from the screw-terminal MS132."),
      PanelComponent(id: "abb-ms165", manufacturer: "ABB", type: "MPCB", model: "MS165", rating: "10-80A", poles: "3P", curve: "Thermal + magnetic, 55mm", about: "Higher-current manual motor starter, 10 to 80A. Trip indication and lockable handle. Short-circuit capacity depends on the rating and voltage."),
      PanelComponent(id: "abb-mo132", manufacturer: "ABB", type: "Magnetic-Only MPCB", model: "MO132", rating: "To 32A class", poles: "3P", curve: "Magnetic only, no overload", about: "Short-circuit protection only, with no thermal overload release. A motor needs a separate overload relay: this does not protect one on its own."),
      PanelComponent(id: "abb-mo165", manufacturer: "ABB", type: "Magnetic-Only MPCB", model: "MO165", rating: "To 80A class", poles: "3P", curve: "Magnetic only, no overload", about: "Magnetic-only protector to the 80A class. No thermal overload release, so a separate overload relay is required for motor duty."),
      PanelComponent(id: "abb-ms132-t", manufacturer: "ABB", type: "Transformer MPCB", model: "MS132-T", rating: "To 32A class", poles: "3P", curve: "Transformer characteristic", about: "Transformer version with a trip characteristic that tolerates energisation inrush. Select on transformer rating, not motor full-load current. KT is the push-in variant."),
      PanelComponent(id: "abb-ms132-l", manufacturer: "ABB", type: "Lamp Circuit MPCB", model: "MS132-L", rating: "Model dependent", poles: "3P", curve: "Lamp-circuit characteristic", about: "Lamp-circuit version for loads with lamp-starting inrush. Not an ordinary motor protector: select on lamp type, wattage and starting current."),
      PanelComponent(id: "abb-ms-legacy", manufacturer: "ABB", type: "Legacy MPCB", model: "MS/MO legacy", rating: "Legacy", poles: "3P", curve: "Verify before reuse", about: "Older ABB motor-protection families including MS225, MS325, MO325, MS450 and MS495. Accessories often do not fit current MS1xx devices."),
    ...
    ComponentGroup(id: "control-automation", name: "Control & Automation", items: [
      ...
      PanelComponent(id: "hager-ezm100", manufacturer: "Hager", type: "Timer", model: "EZM100 multifunction", rating: "8A AC1", poles: "1CO", curve: "12-240V AC/DC, 50ms-100h", about: "Multifunction time relay with a universal 12-240V AC/DC supply and a range from 50ms to 100h, 1 module. One reference covers most timing jobs in a panel."),
      PanelComponent(id: "hager-ezd100", manufacturer: "Hager", type: "Timer", model: "EZD100 on-delay", rating: "8A AC1", poles: "1CO", curve: "24-240V AC/DC, 50ms-100h", about: "On-delay time relay with a universal 24-240V AC/DC supply, 1 module."),
      PanelComponent(id: "hager-ezf100", manufacturer: "Hager", type: "Timer", model: "EZF100 off-delay", rating: "8A AC1", poles: "1CO", curve: "24-240V AC/DC, 50ms-100h", about: "Off-delay time relay with a control input, 24-240V AC/DC, 1 module. Keeps a fan running on after the load stops, for example."),
      PanelComponent(id: "hager-ezl100", manufacturer: "Hager", type: "Timer", model: "EZL100 emergency light tester", rating: "8A AC1", poles: "1CO", curve: "230V AC, 10-180 min", about: "Drops the supply to emergency luminaires for a set 10-180 minute test, so the battery duration can be checked without switching off the lighting circuit."),
      PanelComponent(id: "hager-emn001", manufacturer: "Hager", type: "Timer", model: "EMN001 staircase timer", rating: "16A", poles: "1NO", curve: "230V, 30s-10min", about: "Staircase time-lag switch, 30s to 10min, 1 module. Detects 3- or 4-wire push-button wiring automatically."),
      PanelComponent(id: "hager-een100", manufacturer: "Hager", type: "Twilight Switch", model: "EEN100 / EEN101", rating: "10A AC1", poles: "1NO", curve: "5-2000 lx", about: "1-module DIN-rail twilight switch with a remote light cell, surface (EEN100) or flush (EEN101). Switches outdoor lighting at dusk. Spare cells: EEN002 and EEN003."),
    ]),
    ComponentGroup(id: "relays", name: "Relays", items: [
      ...
      PanelComponent(id: "abb-nf", manufacturer: "ABB", type: "Contactor Relay", model: "NF contactor relay", rating: "Control duty", poles: "4P/8P", curve: "2NO+2NC to 8NO", about: "Contactor relay for control circuits. No main power poles, which is what separates it from a four-pole contactor. Arrangements from 2NO+2NC up to 8NO."),
      PanelComponent(id: "abb-nfz", manufacturer: "ABB", type: "Contactor Relay", model: "NFZ low-consumption", rating: "Control duty", poles: "4P/8P", curve: "Low-consumption coil", about: "Low-consumption contactor relay for PLC and control circuits, the NF equivalent of AFZ."),
      PanelComponent(id: "abb-nfc", manufacturer: "ABB", type: "Contactor Relay", model: "NFC AC-control", rating: "Control duty", poles: "4P/8P", curve: "AC control coil", about: "AC-control contactor relay. Preserve the coil-voltage suffix; NF wide-band coil data does not apply."),
      PanelComponent(id: "abb-nf-b", manufacturer: "ABB", type: "Contactor Relay", model: "NF..B railway", rating: "Rolling stock", poles: "4P/8P", curve: "EN 50155", about: "Railway-qualified contactor relay for rolling-stock control circuits. RT is the ring-tongue terminal version."),
      PanelComponent(id: "abb-k-relay", manufacturer: "ABB", type: "Contactor Relay", model: "K mini-contactor relay", rating: "Control duty", poles: "4P", curve: "Mini relay", about: "Four-pole mini contactor relay for compact control circuits. A relay, not a mini power contactor."),
      ...
      PanelComponent(id: "hager-epn", manufacturer: "Hager", type: "Latching Relay", model: "EPN latching relay", rating: "16A AC1", poles: "1NO-4NO", curve: "Coil 12/24/48/230V", about: "Impulse relay (teleruptor): each pulse from a push button toggles the contacts, so one lighting circuit can be switched from several places. 1NO (1 module) to 4NO or 2NO+2NC (2 modules). Add-on auxiliaries EPN050-053 add central control."),
      PanelComponent(id: "hager-eps", manufacturer: "Hager", type: "Latching Relay", model: "EPS410B / EPS450B electronic", rating: "16A AC1", poles: "1NO", curve: "230V, silent", about: "Silent electronic impulse relay in 1 module with quick-connect terminals. The EPS450B adds a switch-off timer, adjustable from 5 minutes to 1 hour."),
      PanelComponent(id: "hager-load-shed", manufacturer: "Hager", type: "Load-Shedding Relay", model: "60060 / ED183 load shedding", rating: "7-39A setting", poles: "DIN", curve: "Priority load shedding", about: "Keeps a supply under its subscribed current by switching off non-priority loads such as a water heater or an AC unit. The 60060 is a 3-channel universal load shedder, 3 modules; the ED183 is a 1-module intensity relay."),
    ]),
    ...
    ComponentGroup(id: "door-devices", name: "Door & Operator Devices", items: [
      ...
      PanelComponent(id: "generic-door-switch", manufacturer: "Generic", type: "Door Switch", model: "Door position switch", rating: "Set V/A", poles: "NO/NC", curve: "Panel door actuator", about: "Door-position switch used for enclosure lighting, indication or an interlock input. Record the actuator style and contact arrangement; a standard position switch is not automatically a safety-rated guard interlock."),
      PanelComponent(id: "allen-bradley-800f-push-button", manufacturer: "Allen-Bradley", type: "Push Button", model: "800F push button", rating: "22.5mm", poles: "NO/NC blocks", curve: "Momentary or alternate", about: "Allen-Bradley Bulletin 800F push-button operator for a 22.5mm door cut-out. Keep the operator, color, illumination and contact-block arrangement with the exact installed variant."),
      PanelComponent(id: "allen-bradley-800f-selector", manufacturer: "Allen-Bradley", type: "Selector Switch", model: "800F selector switch", rating: "22.5mm", poles: "2/3/4 position", curve: "Maintained or spring return", about: "Allen-Bradley Bulletin 800F selector or key-selector operator. Position count, maintained/spring-return action and contact blocks must match the control scheme."),
      PanelComponent(id: "allen-bradley-800f-pilot-light", manufacturer: "Allen-Bradley", type: "Pilot Light", model: "800F pilot light", rating: "22.5mm", poles: "LED/lamp module", curve: "Voltage and color specific", about: "Allen-Bradley Bulletin 800F pilot-light operator. Record the lens color and the installed LED or lamp-module voltage; the visible operator alone is not a complete orderable assembly."),
      PanelComponent(id: "allen-bradley-800f-estop", manufacturer: "Allen-Bradley", type: "Emergency Stop", model: "800F emergency stop", rating: "22.5mm mounting", poles: "NC contact blocks", curve: "30/40mm operator", about: "Allen-Bradley Bulletin 800F emergency-stop operator. Preserve mushroom size, release method, illumination and positively driven contact arrangement from the drawing or parts schedule."),
      PanelComponent(id: "allen-bradley-800f-contact-block", manufacturer: "Allen-Bradley", type: "Contact Block", model: "800F contact block", rating: "Set V/A", poles: "NO or NC", curve: "Operator accessory", about: "Contact block fitted behind an Allen-Bradley 800F operator. Count it separately only when the drawing or board-specific operator schedule explicitly specifies the installed NO/NC blocks."),
      PanelComponent(id: "allen-bradley-800f-led-module", manufacturer: "Allen-Bradley", type: "Lamp Module", model: "800F LED module", rating: "Set voltage", poles: "Operator module", curve: "Color specific", about: "LED or illumination module fitted behind an Allen-Bradley 800F operator. Voltage and color are stock-defining details and must not be inferred from the operator head alone."),
      PanelComponent(id: "allen-bradley-800t-push-button", manufacturer: "Allen-Bradley", type: "Push Button", model: "800T push button", rating: "30.5mm", poles: "NO/NC blocks", curve: "Oiltight metal operator", about: "Allen-Bradley Bulletin 800T heavy-duty push-button operator for a 30.5mm door cut-out. Record the head style, legend and contact-block arrangement for the installed assembly."),
      PanelComponent(id: "allen-bradley-800t-selector", manufacturer: "Allen-Bradley", type: "Selector Switch", model: "800T selector switch", rating: "30.5mm", poles: "2/3 position", curve: "Maintained or spring return", about: "Allen-Bradley Bulletin 800T heavy-duty selector operator. The position count, key/knob style, return action and contact sequence distinguish the usable variants."),
